...
$mail->Host = User::SmtpData()->pluck('smtp')->first();  // specify main and backup server
...
// pass: password
$mail->Username = User::SmtpData()->pluck('smtpuser')->first();  // SMTP username
$mail->Password = User::SmtpData()->pluck('smtppass')->first(); // SMTP password
