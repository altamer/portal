...
$mail->Host = User::SmtpData()->value('smtp');  // specify main and backup server
...
// pass: password
$mail->Username = User::SmtpData()->value('smtpuser');  // SMTP username
$mail->Password = User::SmtpData()->value('smtppass'); // SMTP password
