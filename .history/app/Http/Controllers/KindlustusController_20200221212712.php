...
$mail->IsSMTP();
$smtp_data = User::SmtpData();
$this->debug_to_console($smtp_data[0]);

// As this email.php script lives on the same server as our email server
// we are setting the HOST to localhost
$mail->Host = "mail.baltiteh.ee";  // specify main and backup server
...
// pass: password
$mail->Username = "reminders@baltiteh.ee";  // SMTP username
$mail->Password = "Rembts2018!"; // SMTP password
